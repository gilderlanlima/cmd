...
import suporteRoutes from "../plugins/suporte/routes/suporteRoutes";
import TicketController from "../plugins/suporte/controllers/TicketController";

const routes = Router();

// 🧩 Rotas públicas para anexos (sem autenticação) - DEVEM VIR PRIMEIRO
routes.get("/plugins/suporte/replies/attachments/:token/download", TicketController.downloadReplyAttachment);
routes.get("/plugins/suporte/replies/attachments/:token/preview", TicketController.previewReplyAttachment);
...
// 🧩 Rotas dos Plugins
// Rotas protegidas do plugin de suporte
routes.use("/plugins/suporte", suporteRoutes);
