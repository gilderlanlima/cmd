...
Invoke-SSHCommand -SSHSession $session -Command 'mkdir -p /tmp/codex-followme-debug && rm -f /tmp/codex-followme-debug/followme-inspect.js' -TimeOut 120000 | Out-Null
...
$cmd = @"
install -D -o deploy -g deploy -m 644 /tmp/codex-followme-debug/followme-inspect.js /home/deploy/inb-staging/backend/followme-inspect.js
su - deploy -c 'cd /home/deploy/inb-staging/backend && node followme-inspect.js'
rm -f /home/deploy/inb-staging/backend/followme-inspect.js
"@
