...
import UserWhatsAppSelect from "../UserWhatsAppSelect";
...
import {
  normalizeUserWorkSchedule,
  USER_WORK_SCHEDULE_DAYS
} from "../../utils/userWorkSchedule";
...
const UserModal = ({ open, onClose, userId }) => {
  ...
  const initialState = {
    ...
    startWork: "00:00",
    endWork: "23:59",
    workSchedule: normalizeUserWorkSchedule(),
    farewellMessage: "",
    allTicket: "enable",
    allowGroup: false,
    defaultTheme: "light",
            ...
            <Form>
              <Paper className={classes.mainPaper} elevation={1}>
                ...
                >
                  ...
                  />
                  <Tab
                    label={i18n.t("userModal.tabs.workSchedule")}
                    value={"workSchedule"}
                  />
                  <Tab
                        ...
                        <>
                          <Box mb={2}>
                            <Typography variant="body2" color="textSecondary">
                              {i18n.t("userModal.form.workScheduleHelp")}
                            </Typography>
                          </Box>
                          {USER_WORK_SCHEDULE_DAYS.map((day, index) => (
                            <Grid
                              container
                              spacing={1}
                              alignItems="center"
                            ...
                            >
                                ...
                                <FormControlLabel
                                  control={
                                    <Switch
                                      color="primary"
                                      checked={
                                        !!values.workSchedule?.[index]?.enabled
                                      }
                                      onChange={event =>
                                        setFieldValue(
                              ...
                              <Grid item xs={12} md={4}>
                                <Field
                                  ...
                                  inputProps={{ step: 600 }}
                                  fullWidth
                                  disabled={!values.workSchedule?.[index]?.enabled}
