...
const DialogflowSchema = Yup.object().shape({
  name: Yup.string()
    ...
    .max(50, "Too Long!")
    .required("Required"),
  flowBuilderId: Yup.string().when("type", {
    is: "flowbuilder",
      ...
      try {
        ...
        setIntegration((prevState) => {
          return {
            ...
            ...data,
            flowBuilderId:
              data.type === "flowbuilder" ? String(data.projectName || "") : "",
          };
        });
      } catch (err) {
        toastError(err);
  ...
  const handleSaveDialogflow = async (values) => {
    try {
      if (values.type === "flowbuilder") {
        values.projectName = values.flowBuilderId;
      }
                      ...
                      <>
                        ...
                        <Grid item xs={12} md={6} xl={6}>
                          <FormControl
                            ...
                            fullWidth
                            error={
                              touched.flowBuilderId &&
                              Boolean(errors.flowBuilderId)
                            }
                          >
                            <InputLabel id="flowbuilder-selection-input-label">
                              {i18n.t(
                                "queueIntegrationModal.form.flowBuilderFlow"
                              )}
                            </InputLabel>
                            ...
                            <Field
                              ...
                              name="flowBuilderId"
                              labelId="flowbuilder-selection-input-label"
